      ...
      <main className="main">
        ...
        <section className="stats">
          <div className="stat-card">
            ...
            <strong>0</strong>
            <span className="stat-description">Active projects</span>
          </div>

          <div className="stat-card">
            <span className="stat-label">Tasks</span>
            <strong>0</strong>
            <span className="stat-description">Tasks assigned</span>
          </div>
          ...
          <div className="stat-card">
            ...
            <strong>0</strong>
            <span className="stat-description">People collaborating</span>
          </div>
        </section>
        ...
        <section className="content-grid">
          <div className="panel">
            ...
            <div className="empty-state">
              ...
              <p>
                Create your first project to start managing your development
                workflow.
              </p>
              <button className="primary-button">
                Create Project
        ...
        <section className="ai-panel">
          ...
          <div>
            ...
            <h2>Let AI help you break down your tasks</h2>
            <p>
